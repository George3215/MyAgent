...
dist/installers/EvoScientist-Studio-0.1.12-macos.dmg
dist/installers/EvoScientist-Studio-0.1.12-macos.pkg
...
dist/installers/EvoScientist-Studio-0.1.12-windows-portable.zip

dist/packages/linux/EvoScientist-Studio.AppDir/
dist/packages/linux/EvoScientist-Studio.AppDir/install.sh
dist/installers/EvoScientist-Studio-0.1.12-linux-appdir.tar.gz
```
...
appimagetool dist/packages/linux/EvoScientist-Studio.AppDir \
  dist/installers/EvoScientist-Studio-0.1.12-linux.AppImage
```
